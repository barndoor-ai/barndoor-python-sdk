...
class Configuration:
    ...
    def __init__(
        ...
        *,
        ...
        """Constructor
        """
        self._base_path = "https://platform.barndoor.ai" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("barndoor")
    ...
    def get_host_settings(self) -> List[HostSetting]:
        ...
        return [
            {
                'url': "https://{host}",
                'description': "Barndoor public API",
                'variables': {
                    'host': {
                        'description': "The host serving your Barndoor deployment. Defaults to production; override it for another environment or a dedicated deployment.",
                        'default_value': "platform.barndoor.ai",
                        'enum_values': []
                        }
                    }
            }
