...
class CreateApiKeyResponse(BaseModel):
    ...
    id: UUID
    key: StrictStr = Field(description="The full API key — only returned at creation time, never stored.")
    key_prefix: StrictStr
    name: StrictStr
    scopes: List[StrictStr]
    __properties: ClassVar[List[str]] = ["created_at", "expires_at", "group_name", "id", "key", "key_prefix", "name", "scopes"]
