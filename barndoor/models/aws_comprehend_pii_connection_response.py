...
class AwsComprehendPiiConnectionResponse(BaseModel):
    """
    ...
    org_id: StrictStr
    region: StrictStr
    __properties: ClassVar[List[str]] = ["access_key_id", "auth_type", "endpoint", "external_id", "has_credentials", "iam_role_arn", "language", "org_id", "region"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AwsComprehendPiiConnectionResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AwsComprehendPiiConnectionResponse from a dict"""
        if obj is None:
            return None
