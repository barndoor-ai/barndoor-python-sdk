...
class CreateConnectionRequest(BaseModel):
    ...
    base_url: StrictStr
    change_note: Optional[StrictStr] = Field(default=None, description="Optional free-text note explaining why this credential was added (BCP-3998). Never a place for key material — the portal's placeholder copy asks for intent, and the value is stored in plaintext on the row and mirrored into the audit event.")
    credentials: Optional[Any] = None
    model_provider: StrictStr
    name: StrictStr
    settings: Optional[Any] = None
    __properties: ClassVar[List[str]] = ["api_key", "auth_type", "base_url", "change_note", "credentials", "model_provider", "name", "settings"]
