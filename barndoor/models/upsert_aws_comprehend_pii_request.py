...
class UpsertAwsComprehendPiiRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["access_key_id", "auth_type", "endpoint", "external_id", "iam_role_arn", "language", "region", "secret_access_key", "session_token"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpsertAwsComprehendPiiRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpsertAwsComprehendPiiRequest from a dict"""
        if obj is None:
            return None
